...
async function searchAPIData(){
    ...
    showSpinner();
    const response = await fetch(`https://api.themoviedb.org/3/search/${global.search.type}?language=en-US&query=${global.search.term}&page=${global.search.page}`, options);
